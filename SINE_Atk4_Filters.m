...
load('C:\Users\shaya\Desktop\Delta Sigma ADC\Code\SINE\Atk4.mat');
...
% Scaling all data
scale_ft = 0.3/mean(abs(yfit(0.6e6:0.7e6))); % For Attack 4 Model (Clean Part)
yfit = yfit * scale_ft;
...
% Scaling all data
scale_ft = 0.3/mean(abs(yfit(0.6e6:0.7e6))); % For Attack 4 Model (Atk4)
yfit = yfit * scale_ft;
...
scale_ft = 0.3/mean(abs(w(0.6e6:0.7e6))); % For Attack 4 Model (Atk4)
w = w * scale_ft;
scale_ft = 0.3/mean(abs(x(1.5e5:2.5e5)));
x = x * scale_ft;
