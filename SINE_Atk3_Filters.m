...
load('C:\Users\shaya\Desktop\Delta Sigma ADC\Code\SINE\Atk3.mat');
...
% Scaling all data
scale_ft = 0.3/mean(abs(yfit(5.7e5:5.8e5))); % For Attack 3 Model (Clean Part)
yfit = yfit * scale_ft;
...
% Scaling all data
scale_ft = 0.3/mean(abs(yfit(5.7e5:5.8e5))); % For Attack 3 Model (Atk3)
yfit = yfit * scale_ft;
...
scale_ft = 0.3/mean(abs(w(5.7e5:5.8e5))); % For Attack 3 Model (Atk3)
w = w * scale_ft;
scale_ft = 0.3/mean(abs(x(1.5e5:2.5e5)));
x = x * scale_ft;
